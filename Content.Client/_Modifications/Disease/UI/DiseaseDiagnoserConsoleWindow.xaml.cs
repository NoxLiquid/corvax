...
public sealed partial class DiseaseDiagnoserConsoleWindow : DefaultWindow
{
    ...
    public DiseaseDiagnoserConsoleWindow()
    {
        ...
        TabContainer.SetTabTitle(ServerTab, Loc.GetString("disease-diagnoser-tab-server"));
        TabContainer.SetTabTitle(DiagnoserTab, Loc.GetString("disease-diagnoser-tab-diagnoser"));
        TabContainer.SetTabTitle(SolutionAnalyzerTab, Loc.GetString("disease-diagnoser-tab-solution-analyzer"));
