...
**Исключение:** Все файлы в директориях `_Modifications` являются собственностью автора **KloopRe** и **НЕ** распространяются под лицензией MIT. Использование в продуктивной среде, модификация, распространение или передача данного кода без явного письменного разрешения автора строго запрещены. 