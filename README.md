...
**Исключение:** Все файлы в директориях `_Modifications` (включая `Content.Server/_Modifications`, `Content.Client/_Modifications`, `Content.Shared/_Modifications`, `Resources/Prototypes/_Modifications`, `Resources/Locale/*/_Modifications`, `Resources/Audio/_Modifications`, `Resources/Textures/_Modifications`, `Resources/Maps/_Modifications`) являются собственностью автора **KloopRe (Nox)** и **НЕ** распространяются под лицензией MIT. Использование в продуктивной среде, модификация, распространение или передача данного кода без явного письменного разрешения автора строго запрещены. Подробности см. в [Content.Server/_Modifications/LICENSE.txt](Content.Server/_Modifications/LICENSE.txt).
